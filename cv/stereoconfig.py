...
def plane_sweep_ncc(im_l, im_r, start, steps, wid):
    ...
    for displ in range(steps):
        # 将左边图像移动到右边，计算加和
        scipy.ndimage.uniform_filter(roll(norm_l, -displ - start) * norm_r, wid, s)  # 和归一化
        scipy.ndimage.uniform_filter(roll(norm_l, -displ - start) * roll(norm_l, -displ - start), wid, s_l)
...
# im_l = array(Image.open('C:/Users/55208/Desktop/CS learning/Python/cv/im2.png').convert('L'), 'f')
# im_r = array(Image.open('C:/Users/55208/Desktop/CS learning/Python/cv/im3.png').convert('L'), 'f')
# # 开始偏移，并设置步长
# steps = 200
# start = 4
#
...
#
# imageio.imsave('D:\python\dipth7.jpg', res)
# imshow(res)
#
# show()
